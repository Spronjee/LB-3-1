...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 09 2023 г., 19:25
...
(5, 'Saturday', 1, '555', 'Computer Networks', 'Practical');
...
--
ALTER TABLE `groups`
  ADD CONSTRAINT `fk_groups_lesson_groups` FOREIGN KEY (`ID_Groups`) REFERENCES `lesson_groups` (`FID_Groups`);

--
-- Ограничения внешнего ключа таблицы `lesson`
--
ALTER TABLE `lesson`
  ADD CONSTRAINT `fk_lesson_lesson_groups` FOREIGN KEY (`ID_Lesson`) REFERENCES `lesson_groups` (`FID_Lesson2`),
  ADD CONSTRAINT `fk_lesson_lesson_teacher` FOREIGN KEY (`ID_Lesson`) REFERENCES `lesson_teacher` (`FID_Lesson1`);

--
-- Ограничения внешнего ключа таблицы `lesson_groups`
--
ALTER TABLE `lesson_groups`
  ADD CONSTRAINT `fk_lesson_groups_groups` FOREIGN KEY (`FID_Groups`) REFERENCES `groups` (`ID_Groups`),
  ADD CONSTRAINT `fk_lesson_groups_lesson` FOREIGN KEY (`FID_Lesson2`) REFERENCES `lesson` (`ID_Lesson`);

--
-- Ограничения внешнего ключа таблицы `lesson_teacher`
--
ALTER TABLE `lesson_teacher`
  ADD CONSTRAINT `fk_lesson_teacher_lesson` FOREIGN KEY (`FID_Lesson1`) REFERENCES `lesson` (`ID_Lesson`),
  ADD CONSTRAINT `fk_lesson_teacher_teacher` FOREIGN KEY (`FID_Teacher`) REFERENCES `teacher` (`ID_Teacher`);

--
-- Ограничения внешнего ключа таблицы `teacher`
--
ALTER TABLE `teacher`
  ADD CONSTRAINT `fk_teacher_lesson_teacher` FOREIGN KEY (`ID_Teacher`) REFERENCES `lesson_teacher` (`FID_Teacher`);
COMMIT;
